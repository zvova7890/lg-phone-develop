...
typedef H_CTRL			(*T_pfnDialog_CreateCmbCtrl)      (H_CTRL hDlg, T_ID ID, T_POS X, T_POS Y, T_SIZE W, T_SIZE H);
...
typedef struct
{
	...
	T_pfnDialog_CreateChkCtrl		pfnCreateChkCtrl;
        T_pfnDialog_CreateCmbCtrl               pfnCreateCmbCtrl; // в апи добавлениа эта ф-ия
	...
	T_pfnDialog_AttachCtrl			pfnAttachCtrl;
      //T_pfnDialog_DettachCtrl			pfnDettachCtrl; - в апи ф-ии нет
...
#define		Dialog_CreateCmbCtrl(p1,p2,p3,p4,p5,p6)	                __ApiLink6(Dialog,CreateCmbCtrl,p1,p2,p3,p4,p5,p6)
