...
#define glDrawPixel16ca(ctx, x, y, c, a) glPutPixel16c(ctx, x, y, glAlphaBlend16_32(c, glGetPixel16(ctx, x, y),  a))


#define glDrawPixel16_16c(ctx, x, y, c, a) glPutPixel16c(ctx, x, y, glAlphaBlend16_16(c, glGetPixel16(ctx, x, y),  a))
