...
unsigned int glDrawUString(GLContext *ctx, const wchar_t *str, int x1, int y1, int x2, int y2, int font, int align, uint8_t leter_step, int32_t max_leter_cnt);
