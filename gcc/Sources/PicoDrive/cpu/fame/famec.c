...
#define WRITE_LONG_DEC_F(A, D)          \
	PicoWrite16((A) + 2, (D) & 0xFFFF);    \
	PicoWrite16((A), (D) >> 16);

#define PUSH_32_F(D)                        \
	AREG(7) -= 4;                               \
	PicoWrite32(AREG(7), D);
...
#define PUSH_16_F(D)                    \
    PicoWrite16(AREG(7) -= 2, D);   \

#define POP_16_F(D)                     \
    D = (u16)PicoRead16(AREG(7));   \
    AREG(7) += 2;
...
#define OPCODE(N_OP) static inline void OP_##N_OP(void)
